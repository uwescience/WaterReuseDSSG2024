...
The user should be able to choose one of these options, or let the pipeline automatically choose the optimal one as a default. To do so, having a set of categories that best describe the input can be helpful. Dimensionality reduction preserves key features of data but gets rid of redundancy. It also allows users to create a single-index that incorporates complex data sets. 
