...
p_load(tidycensus,tidyverse,sf,data.table,tigris,car,janitor,rmapshaper, terra)
...
```{r}
#it doesn't seem like it's keeping the geometry of the county but it is keeping the labeling infomation 
#rasterize shapefiles and do raster joins
cwns_sf <- cwns_sf[1:10,]
...
basins_cwns <- findNearestHUC12(point = cwns_area$geometry, n = 1, ids = TRUE, bb = TRUE)
basins_cwns
